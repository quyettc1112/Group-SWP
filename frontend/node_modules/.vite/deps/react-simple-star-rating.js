  ...
  "node_modules/react-simple-star-rating/dist/index.js"(exports) {
    ...
    !function(e2, t2) {
      ...
      var We = t.useCallback(function(e2) {
        return Se && e2[be] || ke && e2[Me] || _ && e2[je];
      }, [Se, be, ke, Me, _, je]), Te = t.useMemo(function() {
        return Se && Pe(Se) || ke && Pe(ke) || _ && Pe(Ne);
      }, [Se, Pe, ke, _, Ne]);
      return e.jsxs("span", o({ className: l, style: { direction: "".concat(G ? "rtl" : "ltr") } }, { children: [e.jsxs("span", o({ className: "".concat(a, " ").concat(R), style: o({ cursor: b ? "" : "pointer" }, A), onPointerMove: b ? void 0 : Ae, onPointerEnter: b ? void 0 : function(e2) {
        m && m(e2), u() && Ae(e2);
      }, onPointerLeave: b ? void 0 : function(e2) {
        u() && Le(), Ge({ type: "PointerLeave" }), g && g(e2);
      }, onClick: b ? void 0 : Le, "aria-hidden": "true" }, { children: [e.jsx("span", o({ className: "".concat(c, " ").concat(ne), style: o({ color: ee }, te) }, { children: n([], Array(w), true).map(function(o2, n2) {
        var r2;
        return e.jsx(t.Fragment, { children: (null === (r2 = N[n2]) || void 0 === r2 ? void 0 : r2.icon) || Q || e.jsx(i, { SVGclassName: fe, SVGstyle: me, SVGstorkeWidth: xe, SVGstrokeColor: Ce, size: k }) }, n2);
      }) })), e.jsx("span", o({ className: "".concat(s, " ").concat(X), style: o((p = {}, p[G ? "right" : "left"] = 0, p.color = We(U) || J, p.transition = T ? "width .2s ease, color .2s ease" : "", p.width = "".concat(Re, "%"), p), Z), title: "".concat(Se && Pe(Se) || Pe(Ne), " ").concat(ye, " ").concat(w) }, { children: n([], Array(w), true).map(function(o2, n2) {
        var r2;
        return e.jsx(t.Fragment, { children: (null === (r2 = N[n2]) || void 0 === r2 ? void 0 : r2.icon) || O || e.jsx(i, { SVGclassName: fe, SVGstyle: me, SVGstorkeWidth: xe, SVGstrokeColor: Ce, size: k }) }, n2);
      }) }))] })), re && e.jsx("span", o({ className: "".concat(d, " ").concat(ve), style: o((f = {}, f[G ? "marginRight" : "marginLeft"] = 20, f), de) }, { children: (ce.length > 0 ? We(ce) : Te) || ae }))] }));
    };
  }
});
